    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if (snapshot.getValue(articulo.class).getStatus().equals("ACTIVO")&&snapshot.getValue(articulo.class).getCategoria().equals("PAPELERIA")){
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (cont==1){
                            ...
                            Toast.makeText(CarritoCompra.this,"El articulo '"+ productoname +"' No existe", Toast.LENGTH_LONG).show();
                        }
...
public  void comprar(){
    ...
    private void mostrarDialogoPersonalizado(){
        AlertDialog.Builder builder = new AlertDialog.Builder(CarritoCompra.this);
